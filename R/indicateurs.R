utils::globalVariables(c("currency_code", "life_expectancy"))
...
#' Comparer deux pays sur une selection d'indicateurs
#'
...
#' @param indicateurs Vecteur de noms de colonnes a comparer. Par defaut :
#'   PIB, population, esperance de vie, emissions CO2.
